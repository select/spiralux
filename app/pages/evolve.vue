...
function reconstructSpiralConfig(s: ProjectData["paths"][0]["spiral"]): BezierSpiralConfig {
  ...
  return { enabled: s.enabled, lineWidth: s.lineWidth ?? 0.3, rotation: (s as any).rotation ?? 0, scale: (s as any).scale ?? 1, radius: toCurve("radius"), elliptic: toCurve("elliptic"),
